...
qsub -v s3="s3://metanetworks/MSSM/STG/CDR2_5/",dataFile="/shared/MSSM/stgCase.csv",pathv="/shared/metanetworkSynapse/",ridgeCV1se=1,ridgeCVmin=1,ridgeAIC=1,genie3=1,tigressRootN=1,elasticNetAIC=1,elasticNetBIC=1,elasticNetCVmin=1,elasticNetCV1se=1,numberCore=319,outputpath="/shared/MSSM/STG/CDR2_5/" -pe orte 319 -S /bin/bash -V -cwd -N stgCase -e /shared/MSSM/STG/CDR2_5/error.txt -o /shared/MSSM/STG/CDR2_5/out.txt buildNet.sh